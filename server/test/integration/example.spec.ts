...
import {Controller, ExpressApplication, Get, PathParams, Post, Res, PlatformTest} from "@tsed/common";
...
describe("PathParams", () => {
  ...
  before(
    PlatformTest.inject([ExpressApplication], (expressApplication: ExpressApplication) => {
