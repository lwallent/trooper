...
import createAuth0Client, { IdToken, PopupLoginOptions, RedirectLoginResult, getIdTokenClaimsOptions, RedirectLoginOptions, GetTokenSilentlyOptions, GetTokenWithPopupOptions, LogoutOptions, Auth0ClientOptions } from '@auth0/auth0-spa-js';
